...
my @tests = (
	...
	},
	{
		...
		battery => 'empty',
		message => 'Volumes(1): DISK0.0:Optimal; Devices(11): 16=Hotspare 18=JBOD 11,12,13,14,15,17=Online 19,20,21=Unconfigured(good)',
		perfdata => '',
		longoutput => '',
	},
	{
	...
	},
	{
		...
		ldinfo => 'empty',
		battery => 'empty',
		message => 'Volumes(0): ; Devices(11): 16=Hotspare 18=JBOD 11,12,13,14,15,17=Online 19,20,21=Unconfigured(good)',
		perfdata => '',
		longoutput => '',
	},
	{
